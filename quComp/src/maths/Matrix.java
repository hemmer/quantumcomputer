...
public class Matrix {
	...
	public static Matrix multiply(Matrix matrix1, Matrix matrix2) throws IllegalArgumentException {
		...
		Matrix tempMatrix = new Matrix(matrix1.getNumRows(), matrix2.getNumCols());
	...
	public static Matrix tensorProduct(Matrix matrix1, Matrix matrix2){
		...
		Matrix tempMatrix = new Matrix(newRowSize, newColSize);   // initialise temporary matrix
	 ...
	 */
	public static Matrix tranpose(Matrix matrix){
		Matrix tempMatrix = new Matrix(matrix.getNumCols(), matrix.getNumRows()); // swap rows/cols
	...
	public static Matrix outerProduct(Matrix matrix){
		return Matrix.tensorProduct(matrix, Matrix.tranpose(matrix));		
	}
	 ...
	 */
	public static Matrix tensorProductArray(Matrix[] matrixArray){
		
		// start with first entry
		Matrix tempMatrix = matrixArray[0];
	...
	public static Matrix add(Matrix matrix1, Matrix matrix2){
		//catch exception
		Matrix tempMatrix = new Matrix(matrix1.getNumRows(), matrix1.getNumCols());
	 ...
	 */
	public static Matrix scale(ComplexNum factor, Matrix matrix){
		
		Matrix tempMatrix = new Matrix(matrix.getNumRows(), matrix.getNumCols());
